...
import KawasanFallsTrailMap from '../components/kawasanfallstrailmap';
...
import {
  getCurrentWeather,
  KAWASAN_FALLS_COORDS,
  isKawasanFallsLocation,
} from '../services/weatherService';
import { toggleFavorite, isFavorited } from '../services/favoritesService';

// Kawasan Falls specific data
const KAWASAN_FALLS_DATA = {
  id: '3',
  name: 'Kawasan Falls',
  description:
    'Famous multi-tiered waterfall with crystal clear turquoise pools, perfect for canyoneering and swimming adventures.',
...
export default function KawasanFallsScreen({ navigation }) {
  ...
  const spot = KAWASAN_FALLS_DATA;
  const spotId = '3';
  const isKawasanFalls = true;
  ...
  const getSpotImages = useCallback(spotId => {
    try {
      // Use specific Kawasan Falls images
      try {
        return [
          require('../assets/images/kawasan-falls/thumbnail.webp'),
          require('../assets/images/kawasan-falls/main-falls.jpg'),
          require('../assets/images/kawasan-falls/turquoise-pool.jpg'),
          require('../assets/images/kawasan-falls/canyoneering.jpg'),
          require('../assets/images/kawasan-falls/bamboo-raft.jpg'),
          require('../assets/images/kawasan-falls/cliff-jumping.jpg'),
        ];
      } catch (error) {
        return [
      ...
      return [require('../assets/images/spot3.jpg')];
    }
  }, []);
  ...
  useEffect(() => {
    const initializeScreen = async () => {
      try {
        ...
        // Set coordinates for Kawasan Falls
        setCoordinates({
          latitude: 9.8077,
          longitude: 123.3742,
        });
        ...
        console.error('Error initializing Kawasan Falls screen:', error);
      } finally {
        setLoading(false);
      }
    };
      ...
      >
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.mapSection}>
            <KawasanFallsTrailMap
              onRouteSelect={route => {
                console.log('🔥 KawasanFallsScreen - Route selected:', route);
          ...
          <View style={styles.section}>
            ...
            <View style={styles.descriptionCard}>
              ...
              <View style={styles.highlightsContainer}>
                <Text style={styles.highlightsTitle}>Adventure Highlights</Text>
                <View style={styles.highlightsList}>
                  ...
                  <View style={styles.highlightItem}>
                    <MaterialIcons name='sports' size={20} color={'#388E3C'} />
                    <Text style={styles.highlightText}>
