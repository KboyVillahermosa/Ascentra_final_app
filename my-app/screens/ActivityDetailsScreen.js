...
const ActivityDetailsScreen = React.memo(({ route, navigation }) => {
  ...
  useEffect(() => {
    const loadActivity = async () => {
      try {
        ...
        console.warn('Error loading activity details:', error);
      } finally {
        setLoading(false);
      }
    };
        ...
        {activity ? (
          <>
            ...
            <View style={styles.mapContainer}>
              ...
              activity.routeCoordinates.length > 0 ? (
                <MapView
            ...
            <View style={styles.statsContainer}>
              ...
              <View style={styles.statItem}>
                ...
                <Text style={styles.statValue}>
                  {formatPace(activity.stats.pace)}
                </Text>
              ...
              <View style={styles.statItem}>
                ...
                />
                <Text style={styles.statValue}>
                  {activity.stats.elevation?.toFixed(0) || 0} m
                </Text>
