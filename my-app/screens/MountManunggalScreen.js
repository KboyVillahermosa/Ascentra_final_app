...
import MountManunggalTrailMap from '../components/mountmanunggaltrailmap';
...
import {
  getCurrentWeather,
  MOUNT_MANUNGGAL_COORDS,
  isMountManunggalLocation,
} from '../services/weatherService';
// Using ProfileContext for centralized favorites management
import { useProfile } from '../contexts/ProfileContext';

// Mount Manunggal specific data
const MOUNT_MANUNGGAL_DATA = {
  id: '6',
  name: 'Mount Manunggal',
  description:
    "A historic mountain peak where President Ramon Magsaysay crashed in 1957. Features memorial sites and offers scenic views of Cebu's mountainous terrain.",
...
export default function MountManunggalScreen({ navigation }) {
  ...
  const spot = MOUNT_MANUNGGAL_DATA;
  const spotId = '6';
  const isMountManunggal = true;
  ...
  const getSpotImages = useCallback(spotId => {
    try {
      // Use specific Mount Manunggal images
      try {
        return [
          require('../assets/images/mount-manunggal/thumbnail.webp'),
          require('../assets/images/mount-manunggal/memorial-site.jpg'),
          require('../assets/images/mount-manunggal/mountain-trail.jpg'),
          require('../assets/images/mount-manunggal/forest-path.jpg'),
          require('../assets/images/mount-manunggal/summit-view.jpg'),
        ];
      } catch (error) {
        return [
      ...
      return [require('../assets/images/spot6.jpg')];
    }
  }, []);
  ...
  useEffect(() => {
    const initializeScreen = async () => {
      try {
        ...
        // Set coordinates for Mount Manunggal
        setCoordinates({
          latitude: 10.4167,
          longitude: 123.7333,
        });
        ...
        console.error('Error initializing Mount Manunggal screen:', error);
      } finally {
        setLoading(false);
      }
    };
      ...
      >
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.mapSection}>
            <MountManunggalTrailMap
              onRouteSelect={route => {
                console.log('🔥 MountManunggalScreen - Route selected:', route);
          ...
          <View style={styles.section}>
            <View style={styles.descriptionHeader}>
              ...
              <Text style={styles.sectionTitle}>About This Mountain</Text>
            </View>
              ...
              <View style={styles.highlightsContainer}>
                ...
                <View style={styles.highlightsList}>
                  <View style={styles.highlightItem}>
                    <MaterialIcons name='history' size={20} color={'#388E3C'} />
                    <Text style={styles.highlightText}>
                      Memorial site of President Ramon Magsaysay
                    </Text>
                  </View>
                  <View style={styles.highlightItem}>
                    <MaterialIcons
                    ...
                    />
                    <Text style={styles.highlightText}>
                      Scenic views of Cebu's mountainous terrain
                    </Text>
                  </View>
                  <View style={styles.highlightItem}>
                    <MaterialIcons name='nature' size={20} color={'#388E3C'} />
                    <Text style={styles.highlightText}>
                      Rich forest ecosystem and wildlife
                    </Text>
                  </View>
                </View>
              </View>
