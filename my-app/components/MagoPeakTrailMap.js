...
const routes = [
  {
    ...
    duration: '4-6 hours',
    distance: '5 km',
    description: 'Challenging trail to Mago Peak summit with panoramic views.',
    highlights: ['Summit views', 'Mountain ridges', 'Sunrise viewing'],
  },
];

const MagoPeakTrailMap = ({ onRouteSelect, selectedRoute }) => {
  ...
  const mapHtml = `
    ...
    <body>
      <div class="map-container">
        <h2>⛰️ Mago Peak Trail Map</h2>
        <p>📍 Cebu</p>
        
        <div class="trail selected">
          <h3>🥾 Summit Trail</h3>
          <span class="difficulty hard">Hard</span>
          <p>Challenging climb to the peak</p>
        </div>
      </div>
    </body>
    </html>
...
export default MagoPeakTrailMap;
