...
const routes = [
  {
    ...
    duration: '1-2 hours',
    distance: '2 km',
    description: 'The main trail to Binacanyan Falls with scenic views.',
    highlights: ['Natural pools', 'Rock formations', 'Forest views'],
  },
];

const BinacanyanFallsTrailMap = ({ onRouteSelect, selectedRoute }) => {
  ...
  const mapHtml = `
    ...
    <body>
      <div class="map-container">
        <h2>🏞️ Binacanyan Falls Trail Map</h2>
        <p>📍 Cebu</p>
        
        <div class="trail selected">
          <h3>🥾 Main Trail</h3>
          <span class="difficulty easy">Easy</span>
          <p>Scenic path to the falls</p>
        </div>
      </div>
    </body>
    </html>
...
export default BinacanyanFallsTrailMap;
