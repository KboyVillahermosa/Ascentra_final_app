...
const routes = [
  {
    ...
    duration: '2-3 hours',
    distance: '3 km',
    description: 'Trail to Tagapo Falls through lush forest terrain.',
    highlights: ['Forest canopy', 'Natural pools', 'Wildlife viewing'],
  },
];

const TagapoFallsTrailMap = ({ onRouteSelect, selectedRoute }) => {
...
export default TagapoFallsTrailMap;
