...
const routes = [
  {
    ...
    duration: '1-2 hours',
    distance: '2.5 km',
    description: 'Easy trail to Kalawisan Falls with beautiful scenery.',
    highlights: ['Clear waters', 'Swimming spots', 'Rock formations'],
  },
];

const KalawisanFallsTrailMap = ({ onRouteSelect, selectedRoute }) => {
  ...
  const mapHtml = `
    ...
    <body>
      <div class="map-container">
        <h2>🏞️ Kalawisan Falls Trail Map</h2>
        <p>📍 Cebu</p>
...
export default KalawisanFallsTrailMap;
