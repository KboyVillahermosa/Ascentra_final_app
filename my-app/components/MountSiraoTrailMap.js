...
const routes = [
  {
    id: 1,
    name: 'Flower Garden Trail',
    difficulty: 'Easy',
    duration: '2-3 hours',
    distance: '3 km',
    description:
      'Beautiful trail through Mount Sirao flower garden with colorful blooms.',
    highlights: ['Flower gardens', 'Mountain views', 'Cool climate'],
  },
];

const MountSiraoTrailMap = ({ onRouteSelect, selectedRoute }) => {
  ...
  const mapHtml = `
    ...
    <body>
      <div class="map-container">
        <h2>🌸 Mount Sirao Trail Map</h2>
        <p>📍 Cebu City</p>
        
        <div class="trail selected">
          <h3>🥾 Flower Garden Trail</h3>
          <span class="difficulty easy">Easy</span>
          <p>Walk through colorful flower gardens</p>
        </div>
      </div>
    </body>
    </html>
...
export default MountSiraoTrailMap;
