...
const routes = [
  {
    ...
    distance: '4 km',
    description:
      'Trail to Mount Naupa with moderate difficulty and great views.',
    highlights: ['Mountain views', 'Forest trail', 'Wildlife spotting'],
  },
];

const MountNaupaTrailMap = ({ onRouteSelect, selectedRoute }) => {
...
export default MountNaupaTrailMap;
