...
const routes = [
  {
    ...
    distance: '2.5 km',
    description:
      'Easy trail to Kapayas Falls with clear natural pools and scenic views.',
    highlights: ['Natural pools', 'Clear water', 'Easy access'],
  },
];

const KapayasFallsTrailMap = ({ onRouteSelect, selectedRoute }) => {
  ...
  const mapHtml = `
    ...
    <body>
      <div class="map-container">
        <h2>🏞️ Kapayas Falls Trail Map</h2>
        <p>📍 Cebu</p>
        
        <div class="trail selected">
          <h3>🥾 Main Trail</h3>
          <span class="difficulty easy">Easy</span>
          <p>Easy walk to natural pools</p>
        </div>
      </div>
    </body>
    </html>
...
export default KapayasFallsTrailMap;
