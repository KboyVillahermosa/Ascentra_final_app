...
const routes = [
  {
    ...
    distance: '3.5 km',
    description:
      'Trail to Kan-Irag Falls with moderate difficulty and refreshing swimming spots.',
    highlights: ['Multi-tiered falls', 'Swimming pools', 'Rock formations'],
  },
];

const KanIragFallsTrailMap = ({ onRouteSelect, selectedRoute }) => {
...
export default KanIragFallsTrailMap;
